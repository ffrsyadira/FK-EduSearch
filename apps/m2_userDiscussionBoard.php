    ...
    <div class="contentpart">
        ...
        <div id="maincontentpage">
            <div class="p-2 mb-1 bg-primary text-white">
                <h5 class="text-uppercase fw-bolder">DISCUSSION BOARD</h5>
            </div>
            <div class="d-flex align-items-center justify-content-center">
                <div>
                <div class="list-group" style="width: 14rem;">
                        <br>
                        <!-- <a href="m2_userAssignPost.php"> -->
                        <button class="btn fw-bolder mb-2 btnusername" id="" name="Assignpost" onclick="window.location.href='m2_userAssignPost.php';">ASSIGN POST</button>
                        <!-- <a href="m2_userPostStatus.php"> -->
                        <button class="btn fw-bolder mb-2 btnusername" id="" name="Poststatus" onclick="window.location.href='m2_userPostStatus.php';">POST STATUS</button>
                    </div>
                </div>
            </div>
        </div>
